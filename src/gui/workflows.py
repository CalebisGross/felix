        ...
        try:
            ...
            with open(file_path, 'w', encoding='utf-8') as f:
                ...
                if final_synthesis:
                    ...
                    f.write(f"Generated by: CentralPost (Smart Hub Synthesis)\n")
                    f.write(f"Confidence: {final_synthesis.get('confidence', 0.0):.2f}\n")
                    f.write(f"Synthesis Time: {final_synthesis.get('synthesis_time', 0):.2f}s\n")
                    f.write(f"Tokens: {final_synthesis.get('tokens_used', 0)} / {final_synthesis.get('max_tokens', 0)}\n")
                    f.write(f"Temperature: {final_synthesis.get('temperature', 0):.2f}\n")
                    f.write(f"Agents Synthesized: {final_synthesis.get('agents_synthesized', 0)}\n")
                    f.write(f"Avg Agent Confidence: {final_synthesis.get('avg_agent_confidence', 0):.2f}\n")
                    f.write("\n")
